class Ajax_foto_copy
{
    ...
    public enviar_GET(ruta : string, parametros : string = "", /*auxiliar_ready : Function ,*/exito? : Function, error? : Function) : void
    {
    ...
    public enviar_POST(ruta : string, form : FormData, /*auxiliar_ready : Function,*/exito? : Function, error? : Function) : void
    {
        if(ruta != undefined && ruta.length > 0 &&
