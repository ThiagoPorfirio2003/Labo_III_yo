    ...
    //{
        switch($accion)
        {
            ...
            case "agregar":
                ...
                {
                    $respuesta = "Se agrego exitosamente";
                }
                break;
            ...
            case "modificar":
                ...
                {
                    $respuesta = "Se mofifico el alumno";
                }
                else
                {
                    $respuesta = "Hubo un error o el legajo no coincide con el de algun alumno";
                }
                break;

                case "obtener";
                    $alumno = Alumno::Obtener_Alumno($legajo);
                    isset($alumno) !== null ? $respuesta = var_dump($alumno) : $respuesta = "No se encontro al alumno";
